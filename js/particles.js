var opts = {
    ...
    cell_size: 50,                    // Size of the cells used to generate a randomized grid
    variance: 1,                   // how much to randomize the grid
    seed: null,                       // Seed for the RNG
    x_colors: 'random',               // X color sstops
...
var pJS = function(tag_id, params){
    ...
    pJS.fn.particle.points = function(width, height, bleed_x, bleed_y, cell_size, variance) {
        var w = width + bleed_x;
        ...
        for (var i = -bleed_x; i < w; i += cell_size) {
            for (var j = -bleed_y; j < h; j += cell_size) {
                console.log(i, j, half_cell_size, double_v, negative_v);
                var x = (i + half_cell_size) + (Math.random() * double_v + negative_v);
                var y = (j + half_cell_size) + (Math.random() * double_v + negative_v);
    ...
    pJS.fn.particlesCreate = function(){
        ...
        for(var i = 0; i < points.length; i++) {
            pJS.particles.array.push(new pJS.fn.particle(pJS.particles.color, pJS.particles.opacity.value, {'x':points[i][0], 'y':points[i][1]}));
        }
    };
